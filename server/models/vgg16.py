...
async def train_and_get_accuracy_vgg16(email, no_of_classes):
    ...
    weights_path = os.path.join(script_dir, "models", "vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5")
    evaluation_file = os.path.join(upload_dir, "evaluation_results_VGG.txt")
    ...
    plt.savefig(os.path.join(upload_dir, 'loss_function_plot_VGG.png'))
    plt.close()
    ...
    model.save(os.path.join(upload_dir, "vgg16.keras"))
